 ...
 *	 Bingo ( Or Not )
 *	 
 *	 For this game of BINGO, you will receive a single array of 10 numbers from 1 to
 *	 26 as an input. Duplicate numbers within the array are possible.
 *	 
...
function bingo(a) {
	return [...new Set(a.filter( n => [98, 103, 105, 110, 111].includes(n+96)) )].length == 5 ? 'WIN' : 'LOSE'
}
